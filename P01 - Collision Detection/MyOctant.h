/*----------------------------------------------
Programmer: Lab N (lab@mail.rit.edu)
Date: 2018/11
----------------------------------------------*/
#pragma once
...
class MyOctant
{
	...
	vector3 m_v3Center = vector3(); //Will store the center point of the octant
	vector3 m_v3Min = vector3(); //Will store the minimum vector of the octant
	vector3 m_v3Max = vector3(); //Will store the maximum vector of the octant
	vector3 m_v3Size = vector3(); //Will store the size of this octant for drawing
